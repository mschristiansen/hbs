CC=avr-g++
CFLAGS = -Wall -g -Os -w -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -MMD -mmcu=$(MCU) -DF_CPU=$(F_CPU) -DARDUINO=10804 -DARDUINO_AVR_UNO -DARDUINO_ARCH_AVR -I$(ARDUINO_PATH) -I$(VARIANT_PATH)
...
led.elf: libArduino.a led.o Temperature.o OneWire.o
	$(CC) $(FDFLAGS) led.o Temperature.o OneWire.o libArduino.a -lm -o led.elf
